    ...
    if (active && payload && payload.length) {
        ...
        return (
            <ChartTooltipContainer>
                ...
                <ChartTooltipItem color={chartConfig.result.color} label={`${chartConfig.result.label}:`}  value={formatNumber(data.result)} />
                <ChartTooltipItem color={chartConfig.liquidity.color} label={`${chartConfig.liquidity.label}:`}  value={formatNumber(data.liquidity)} />
            </ChartTooltipContainer>
        );
    }
